!(function(t, e) {
	...
	function r(t) {
		return 'symbol' == typeof t || (i(t) && _.call(t) == b)
	}
	function o(t) {
		return t
	...
	var v = 'Expected a function',
		...
		T = function(t, e, n) {
			...
			return new Promise(function(r) {
				e.addEventListener(t, w(i.bind(null, r))), n()
			})
		},
		C = function(t) {
			var e = void 0
		...
		k = function() {
			...
			;(this.defaults = {
				...
				(this.setOptions = function() {
					...
					return (t.options = I({}, t.options, { options: e })), t
				}),
				(this.init = function() {
					var e = t.options,
						n = e.selector,
					...
					return (
						...
						(t.animationEvent = C(o)),
						t.handle,
						t.timer,
						!p && t.$slides[0].classList.add(a),
						(t.startingIndex = d(t.$slides)),
						(t.machine = A(t.$slides, l)),
				...
				(this.goTo = function(e) {
					if (!((t.currentIndex === e && t.started) || t.isRuning)) {
						...
						var n = t.options,
							...
							p = I({}, d, { newIndex: e, currentIndex: t.currentIndex })
						s || t._updateButtonStates(e),
							r && t._cancelLoop(),
							'animation' === o || 'transition' === o
								? t.before(I({}, p)).then(function() {
				...
				(this._cancelLoop = function() {
					cancelAnimationFrame(t.handle), clearTimeout(t.timetimerout)
				})
		}
	return function e(n) {
